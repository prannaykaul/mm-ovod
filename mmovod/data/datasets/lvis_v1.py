...
_CUSTOM_SPLITS_LVIS = {
    ...
    "lvis_v1_val_rareonly": ("coco/", "lvis/lvis_v1_val_rare_only.json"),
    "lvis_v1_val_norare": ("coco/", "lvis/lvis_v1_val_norare.json"),
    "lvis_v1_train_rareonly": ("coco/", "lvis/lvis_v1_train_rare_only.json"),
}
